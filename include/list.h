 ...
 */
static void __INLINE__ __list_add(struct list_head *_new,
...
#define list_for_each(pos, head) \
	for (pos = (head)->next, __PREFETCH__(pos->next); pos != (head); \
        	pos = pos->next, __PREFETCH__(pos->next))
...
#define list_for_each_prev(pos, head) \
	for (pos = (head)->prev, __PREFETCH__(pos->prev); pos != (head); \
        	pos = pos->prev, __PREFETCH__(pos->prev))
